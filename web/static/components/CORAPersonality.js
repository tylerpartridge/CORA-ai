...
class CORAPersonality {
    constructor() {
        console.log("🤖 CORAPersonality constructor called");
        ...
        console.log("🤖 CORAPersonality constructor completed, calling init()");
        this.init();
    }

    init() {
        console.log("🔧 CORAPersonality init() called");
        try {
            this.createPersonalityUI();
            console.log("✅ createPersonalityUI() completed");
            
            this.integrateComponents();
            console.log("✅ integrateComponents() completed");
            
            this.startPersonalityEngine();
            console.log("✅ startPersonalityEngine() completed");
            
            this.injectStyles();
            console.log("✅ injectStyles() completed");
            
            console.log("🎉 CORAPersonality initialization completed successfully!");
        } catch (error) {
            console.error("💥 Error in CORAPersonality init():", error);
            throw error;
        }
    }
    ...
    createPersonalityUI() {
        try {
            ...
            this.bindEvents();
            console.log("✅ Personality UI created successfully");
        } catch (error) {
            console.error("❌ Error creating personality UI:", error);
            throw error;
        }
    }
    ...
    bindEvents() {
        try {
            ...
            const avatar = document.getElementById('cora-avatar');
            if (avatar) {
    ...
    async generatePersonalityResponse(message, context) {
        try {
            ...
            if (response.ok) {
                ...
                // Update personality state with AI response
                this.conversationState.relationshipLevel = data.personality_state.relationship_level;
                this.conversationState.trustScore = data.personality_state.trust_score;
                
                return data.response;
            } else {
                // Fallback to predefined responses if AI service fails
...
// Remove automatic initialization - let the demo page handle it
